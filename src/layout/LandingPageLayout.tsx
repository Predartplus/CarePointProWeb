  ...
  return (
    <div>
      <div className="cpp__wrapper">
        <div className="cpp__container container mx-auto">
          <header>
            <div className="cpp__header flex justify-between items-center">
              <div className="cpp__header--mainMenu"></div>
            </div>
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
              <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link className="flex items-center space-x-3 rtl:space-x-reverse" to="/">
                  <img src={LogoIcon} className="h-14" alt="CarePointPro Logo" />
                </Link>
                <button
